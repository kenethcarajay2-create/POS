...
Allows an administrator to correct an existing:
...
The service/controller is responsible for reversing the
effects of the original transaction before applying the
updated transaction.
...
- Add/remove product
- Change custom Grocery amount
- Change custom Grocery name
- Change remarks
...
All changes should be recorded in editHistory.
============================================================
*/
